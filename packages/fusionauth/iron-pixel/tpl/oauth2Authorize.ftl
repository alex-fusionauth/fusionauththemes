...
[@helpers.html]
  ...
  [@helpers.body]
    ...
    <section id="fatheme-login-container" class="card bg-base-200 w-80 bg-[https://res.cloudinary.com/djox1exln/image/upload/v1739199486/cbfdbbbe1c08984c203d09fe5e60d1df_fhm7lg.jpg]">
      [@helpers.main title=theme.message("login")]
        ...
        [/#if]
        <form action="${request.contextPath}/oauth2/authorize" method="POST" class="">
